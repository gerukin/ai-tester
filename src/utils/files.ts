 ...
 */
export const getFileInfo = (basePath: string, filePath: string, encoding?: BufferEncoding) => {
 ...
 */
export const listAllYamlFiles = (basePath: string): string[] => {
	if (!fs.existsSync(basePath)) throw new Error(`File or directory not found: ${basePath}`)
