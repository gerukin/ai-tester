...
import { z } from 'zod';
import { DEFAULT_MAX_WAIT_TIME, DEFAULT_CONFIG_FILE_PATH, MAX_TEST_OUTPUT_TOKENS, MAX_TEST_THINKING_TOKENS, MAX_EVALUATION_OUTPUT_TOKENS, MAX_EVALUATION_THINKING_TOKENS, } from './constants.js';
...
export const envConfig = z
    ...
    AI_TESTER_CURRENCIES_DIR: z.string().min(1).optional(),
    ...
    AI_TESTER_CURRENCIES_DIR: process.env['AI_TESTER_CURRENCIES_DIR'],
