...
import { clearFileBackedCurrencyRegistryCache, getFileBackedCurrencyRegistry, isCurrencyRegistryConfigured, validateCurrencyRegistryReferences, } from '../config/currency-registry.js';
...
const syncCurrencyRates = async (tx, currencyDefinition) => {
