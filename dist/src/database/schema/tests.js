...
export const testToSystemPromptVersionRels = sqliteTable('test_to_system_prompt_version_rels', {
    /** The id of the test */
...
export const testEvaluationInstructionsVersions = sqliteTable('test_evaluation_instructions_versions', {
