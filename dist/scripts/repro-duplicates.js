...
async function getDuplicateCount() {
    ...
    const duplicates = allVersions.filter((v, i, self) => self.findIndex(t => t.providerId === v.providerId && t.providerModelCode === v.providerModelCode && t.extraIdentifier === v.extraIdentifier) !== i);
